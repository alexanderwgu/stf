...
module.exports.builder = function(yargs) {
  return yargs
    ...
    .option('memory-summary-enabled', {
      describe: 'Enable LLM-based per-device memory summaries.'
    , type: 'boolean'
    , default: true
    })
    .option('memory-summary-model', {
      describe: 'Override model name for memory summaries.'
    , type: 'string'
    })
    .option('memory-summary-max-input-chars', {
      describe: 'Max relevant log chars sent to the memory summarizer.'
    , type: 'number'
    , default: 5000
    })
...
module.exports.handler = function(argv) {
  ...
  , memorySummaryEnabled: argv.memorySummaryEnabled
  , memorySummaryModel: argv.memorySummaryModel
  , memorySummaryMaxInputChars: argv.memorySummaryMaxInputChars
  })
}
